...
const legalPagesData = {
  "privacy-policy": {
    ...
    description:
      "Please read our privacy policy carefully before using FacebookDl.app services.",
    sections: [
      {
      ...
      },
      {
        ...
        text: "Our service may use third-party analytics tools to understand usage patterns. These services have their own privacy policies that we encourage you to review.",
      },
      {
        heading: "5. Cookies and Tracking",
        text: "We may use cookies and similar technologies to enhance user experience and analyze service usage. You can control cookie settings through your browser preferences.",
      },
      {
        heading: "6. Data Sharing",
        text: "We do not sell, trade, or share your personal information with third parties except as required by law or to protect our legal rights.",
      },
      {
  ...
  "terms-and-conditions": {
    ...
    description:
      "Please read these terms carefully before using FacebookDl.app services.",
    sections: [
      {
        heading: "1. Acceptance of Terms",
        text: "By accessing and using FacebookDl.app, you accept and agree to be bound by the terms and provision of this agreement. If you do not agree to abide by the above, please do not use this service.",
      },
      {
      ...
      },
      {
        ...
        list: [
          ...
          "Not attempt to interfere with the proper functioning of the service",
        ],
      },
      {
        heading: "4. Copyright and Intellectual Property",
        text: "Users are responsible for ensuring they have the right to download and use any content. FacebookDl.app does not claim ownership of any downloaded content. We respect intellectual property rights and expect our users to do the same.",
      },
      {
        heading: "5. Limitation of Liability",
        text: "FacebookDl.app shall not be liable for any direct, indirect, incidental, special, or consequential damages resulting from the use or inability to use our service.",
      },
      {
